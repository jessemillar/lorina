l.finger = function() {
    ...
    l.globals.dom.addEventListener('touchstart', function(event) {
        self.touches(event);
    }, false);
    l.globals.dom.addEventListener('touchmove', function(event) {
        self.touches(event);
    }, false);
    l.globals.dom.addEventListener('touchend', function() {
        self.clearTouches();
    }, false);
    l.globals.dom.addEventListener('touchcancel', function() {
        self.clearTouches();
    }, false);
