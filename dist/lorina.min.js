...
this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y,this.momentum.y=-this.momentum.y);return this};this.applyPhysics=function(){if(this.momentum.x||this.momentum.y)Math.abs(this.momentum.x)>Math.abs(this.momentum.y)?(this.friction.x=this.friction.movement,this.friction.y=Math.abs(this.momentum.y/this.momentum.x*this.friction.movement)):(this.friction.x=Math.abs(this.momentum.x/this.momentum.y*this.friction.movement),this.friction.y=this.friction.movement);0!==this.momentum.x&&(this.moveHorizontal(this.momentum.x),
0>this.momentum.x?(this.momentum.x+=this.friction.x,0<this.momentum.x&&(this.momentum.x=0)):0<this.momentum.x&&(this.momentum.x-=this.friction.x,0>this.momentum.x&&(this.momentum.x=0)));0!==this.momentum.y&&(this.moveVertical(this.momentum.y),0>this.momentum.y?(this.momentum.y+=this.friction.y,0<this.momentum.y&&(this.momentum.y=0)):0<this.momentum.y&&(this.momentum.y-=this.friction.y,0>this.momentum.y&&(this.momentum.y=0)));0!==this.momentum.rotation&&(this.rotation+=this.momentum.rotation,0>this.momentum.rotation?
(this.momentum.rotation+=this.friction.rotation,0<this.momentum.rotation&&(this.momentum.rotation=0)):0<this.momentum.rotation&&(this.momentum.rotation-=this.friction.rotation,0>this.momentum.rotation&&(this.momentum.rotation=0)));return this}};l.finger=function(){this.touching=!1;this.y=this.x=void 0;this.database=[];var a=this;l.globals.dom.addEventListener("touchstart",function(b){a.touches(b)},!1);l.globals.dom.addEventListener("touchmove",function(b){a.touches(b)},!1);l.globals.dom.addEventListener("touchend",function(){a.clearTouches()},!1);l.globals.dom.addEventListener("touchcancel",function(){a.clearTouches()},!1);this.touches=function(a){this.touching=!0;this.x=a.touches[0].clientX;this.y=a.touches[0].clientY;this.database=a.touches};
