...
b,a.y=mouse.y-c),b||c||(b=mouse.x-a.x,c=mouse.y-a.y));return this};this.checkMiddleClicked=function(a){return this.middleClick&&this.x<a.x+a.bound.x+a.bound.width&&this.x>a.x+a.bound.x&&this.y<a.y+a.bound.y+a.bound.height&&this.y>a.y+a.bound.y?!0:!1};this.checkRightClicked=function(a){return this.rightClick&&this.x<a.x+a.bound.x+a.bound.width&&this.x>a.x+a.bound.x&&this.y<a.y+a.bound.y+a.bound.height&&this.y>a.y+a.bound.y?!0:!1};this.cancel=function(){1==event.which?this.leftClick=!1:2==event.which?
this.middleClick=!1:3==event.which&&(this.rightClick=!1,event.preventDefault())}};var Pencil=function(){this.setPosition=function(a,b){this.x=a;this.y=b;return this};this.setEndPosition=function(a,b){this.endX=a;this.endY=b;return this};this.setSize=function(a,b){this.width=a;this.height=b;return this};this.setRadius=function(a){this.radius=a;return this};this.setColor=function(a){this.color=a;return this};this.setOpacity=function(a){this.opacity=a;return this};this.setStroke=function(a){this.stroke=a;return this};this.setArc=function(a,b){this.start=a;this.stop=b;return this};
