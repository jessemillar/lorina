var l={globals:{dom:document.createElement("canvas"),room:{},zBuffer:[],camera:{state:"resting",x:0,y:0,previous:{x:0,y:0},sandbox:{width:1,height:1}}},lorina:function(){var a=this;this.setRoomSize=function(a,c){l.globals.room.width=a;l.globals.room.height=c;return this};this.setDomSize=function(a,c){l.globals.dom.width=a;l.globals.dom.height=c;return this};this.setDomPosition=function(a,c){l.globals.dom.style.position="absolute";l.globals.dom.style.left=a+"px";l.globals.dom.style.top=c+"px";return this};
this.setTitle=function(a){document.title=a;return this};this.scale=function(a){l.globals.ctx.imageSmoothingEnabled=!1;l.globals.ctx.scale(a/100,a/100);return this};this.makeFullscreen=function(){document.body.style.background=this.color;window.onresize=function(){a.setFullscreen()};this.setFullscreen();return this};this.setFullscreen=function(){a.setDomPosition(0,0);a.setDomSize(window.innerWidth,window.innerHeight);a.setRoomSize(l.globals.dom.width,l.globals.dom.height)};this.appendCanvas=function(){document.body.appendChild(l.globals.dom);
l.globals.ctx=l.globals.dom.getContext("2d")};this.hideCursor=function(){l.globals.dom.style.cursor="none";return this};this.setRoom=function(a){l.globals.room.current=a;window.requestAnimationFrame(a);return this};this.start=function(a){this.setRoom(a);return this};this.setColor=function(a){this.color=a;return this};this.blank=function(a){l.globals.ctx.fillStyle=a?a:this.color;l.globals.ctx.fillRect(0,0,l.globals.dom.width,l.globals.dom.height);l.globals.zBuffer.length=0;return this};this.draw=function(){l.globals.zBuffer.sort(function(a,
b){return a.y-b.y});for(var a=0;a<l.globals.zBuffer.length;a++)l.globals.zBuffer[a].draw();window.requestAnimationFrame(l.globals.room.current);return this}}};l.accelerometer=function(){var a=this;this.z=this.y=this.x=0;this.rotation={x:0,y:0,z:0};window.ondeviceorientation=function(b){a.x=b.beta;a.y=b.gamma;a.z=b.alpha};window.ondevicemotion=function(b){b=b.rotationRate;a.rotation.x=b.alpha;a.rotation.y=b.beta;a.rotation.z=b.gamma};this.debug=function(){console.log(Math.round(this.x),Math.round(this.y),Math.round(this.z),Math.round(this.rotation.x),Math.round(this.rotation.y),Math.round(this.rotation.z));return this}};l.camera=function(){this.reset=function(){l.globals.camera.x=0;l.globals.camera.y=0;return this};this.setSandbox=function(a,b){l.globals.camera.sandbox.width=a;l.globals.camera.sandbox.height=b;0>=l.globals.camera.sandbox.width&&(l.globals.camera.sandbox.width=1);0>=l.globals.camera.sandbox.height&&(l.globals.camera.sandbox.height=1);return this};this.follow=function(a,b){var c,d;a.deleted||(b&&!b.deleted?(c=a.x<b.x?(b.x-a.x)/2+a.x:(a.x-b.x)/2+b.x,d=a.y<b.y?(b.y-a.y)/2+a.y:(a.y-b.y)/2+b.y):(c=a.x,
...
c))};this["delete"]=function(a,b){if(b){if(sessionStorage.getItem(a))return sessionStorage.removeItem(a),!0}else if(localStorage.getItem(a))return localStorage.removeItem(a),!0;return!1};this.clear=function(a){a?sessionStorage.clear():localStorage.clear();return!0}};l.entity=function(){this.rotation=0;this.sprite={img:new Image};this.previous={x:0,y:0};this.anchor={x:0,y:0};this.bound={x:0,y:0,width:0,height:0};this.debug=function(a){this.deleted||(l.globals.ctx.fillStyle=a?a:"#FF0000",l.globals.ctx.globalAlpha=.5,l.globals.ctx.fillRect(this.x+this.bound.x-l.globals.camera.x,this.y+this.bound.y-l.globals.camera.y,this.bound.width,this.bound.height),l.globals.ctx.fillRect(this.x-2-l.globals.camera.x,this.y-2-l.globals.camera.y,5,5),l.globals.ctx.globalAlpha=1);
return this};this["delete"]=function(){this.deleted||(this.deleted=!0,this.freeze());return this};this.banish=function(a){this.deleted||(a||(a=300),(this.x<-a||this.x>l.globals.room.width+a||this.y<-a||this.y>l.globals.room.height+a)&&this["delete"]());return this};this.setTrait=function(a,b){this[a]=b;return this};this.deleteTrait=function(a){delete this[a];return this};this.setPosition=function(a,b){this.x=a;this.y=b;return this};this.recordDifference=function(a,b){"horizontal"==a?this.previous.x=
b:"vertical"==a&&(this.previous.y=b);return this};this.setAnchor=function(a,b){this.anchor={x:a,y:b};this.width&&this.height&&this.setBound(0-this.anchor.x,0-this.anchor.y,this.width,this.height);return this};this.setSize=function(a,b,c){this.width=a;this.height=b;c&&this.setBound(this.x,this.y,this.width,this.height);return this};this.setStretch=function(a,b,c,d){this.stretch={width:a,height:b};c&&this.setSize(a,b);d&&this.setBound(0,0,a,b);return this};this.setBound=function(a,b,c,d){this.bound=
{x:a,y:b,width:c,height:d};return this};this.rotate=function(a){this.rotation+=a;this.fixRotation();return this};this.rotateTo=function(a){this.rotation=a;this.fixRotation();return this};this.fixRotation=function(){0>this.rotation?this.rotation+=360:360<this.rotation&&(this.rotation-=360);return this};this.steer=function(){this.rotation=180*-Math.atan(this.previous.y/this.previous.x)/Math.PI;0>this.previous.x&&(this.rotation+=180);return this};this.setSprite=function(a,b,c){var d=this;this.sprite.img.onload=
function(){d.sprite.width=this.width;d.sprite.height=this.height;(b||void 0==b)&&d.setSize(this.width,this.height);(c||void 0==c)&&d.setBound(0-d.anchor.x,0-d.anchor.y,this.width,this.height)};this.sprite.img.src=a;return this};this.setAnimation=function(a,b){this.sprite.frame=0;this.sprite.count=a;this.sprite.timer=Math.round(b);var c=this;this.animation=setInterval(function(){c.sprite.frame=c.sprite.frame<c.sprite.count-1?c.sprite.frame+1:0},c.sprite.timer);return this};this.pauseAnimation=function(){this.sprite.animation&&
clearInterval(this.sprite.animation);return this};this.setOpacity=function(a){this.opacity=a;return this};this.fadeOut=function(a){this.opacity=0<this.opacity?this.opacity-a:0;return this};this.fadeIn=function(a){this.opacity=1>this.opacity?this.opacity+a:1;return this};this.buffer=function(){this.deleted||l.globals.zBuffer.push(this);return this};this.flip=function(a){this.flipped=a;return this};this.unflip=function(){"horizontal"==this.flipped?"both"==this.flipped?this.flipped="vertical":delete this.flipped:
"vertical"==this.flipped?"both"==this.flipped?this.flipped="vertical":delete this.flipped:"both"==this.flipped&&delete this.flipped;return this};this.hud=function(){this.drawMode="hud";return this};this.draw=function(){"hud"==this.drawMode?this.cameraY=this.cameraX=0:(this.cameraX=l.globals.camera.x,this.cameraY=l.globals.camera.y);this.deleted||(l.globals.ctx.globalAlpha=this.opacity,this.flipped||this.rotation?(l.globals.ctx.save(),"undefined"!==this.flipped&&("horizontal"==this.flipped?(l.globals.ctx.translate(Math.round(this.x-
2*this.anchor.x+this.width-this.cameraX),Math.round(this.y-this.cameraY)),l.globals.ctx.scale(-1,1)):"vertical"==this.flipped?(l.globals.ctx.translate(Math.round(this.x-this.cameraX),Math.round(this.y-2*this.anchor.y+this.height-this.cameraY)),l.globals.ctx.scale(1,-1)):"both"==this.flipped&&(l.globals.ctx.translate(Math.round(this.x-2*this.anchor.x+this.width-this.cameraX),Math.round(this.y-2*this.anchor.y+this.height-this.cameraY)),l.globals.ctx.scale(-1,-1))),this.rotation&&(l.globals.ctx.translate(Math.round(this.x-
this.cameraX),Math.round(this.y-this.cameraY)),l.globals.ctx.rotate(this.rotation*Math.PI/180*-1)),this.stretch?this.sprite.count?l.globals.ctx.drawImage(this.sprite.img,this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y),this.sprite.width/this.sprite.count,this.sprite.height,this.stretch.width,this.stretch.height):l.globals.ctx.drawImage(this.sprite.img,Math.round(0-this.anchor.x),Math.round(0-
this.anchor.y),this.stretch.width,this.stretch.height):this.sprite.count?l.globals.ctx.drawImage(this.sprite.img,this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y),this.sprite.width/this.sprite.count,this.sprite.height):l.globals.ctx.drawImage(this.sprite.img,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y)),l.globals.ctx.restore()):this.stretch?this.sprite.count?l.globals.ctx.drawImage(this.sprite.img,
this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY),this.sprite.width/this.sprite.count,this.sprite.height,this.stretch.width,this.stretch.height):l.globals.ctx.drawImage(this.sprite.img,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY),this.stretch.width,this.stretch.height):this.sprite.count?l.globals.ctx.drawImage(this.sprite.img,
this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY),this.sprite.width/this.sprite.count,this.sprite.height):l.globals.ctx.drawImage(this.sprite.img,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY)));l.globals.ctx.globalAlpha=1;return this};this.snapTo=function(a,b){this.x=a;this.y=b;return this};this.moveHorizontal=
...
function(a,b){this.moveHorizontal(Math.cos(a*Math.PI/180)*b);this.moveVertical(-Math.sin(a*Math.PI/180)*b);return this};this.contain=function(a,b,c,d){a||b||c||d||(a=0,b=l.globals.room.width,c=0,d=l.globals.room.height);this.x+this.bound.x<=a?this.x=a-this.bound.x:this.x+this.bound.x+this.bound.width>=b&&(this.x=b-this.bound.width-this.bound.x);this.y+this.bound.y<=c?this.y=c-this.bound.y:this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y);return this};this.setFriction=
function(a,b){this.friction=b?{x:0,y:0,movement:a,rotation:b}:{x:0,y:0,movement:a,rotation:a};this.momentum={x:0,y:0,rotation:0};return this};this.freeze=function(){this.momentum={x:0,y:0,rotation:0};this.momentum.rotation=0;return this};this.spin=function(a){this.momentum.rotation=a;return this};this.pushTowardDegree=function(a,b){this.momentum.x=Math.cos(a*Math.PI/180)*b;this.momentum.y=-Math.sin(a*Math.PI/180)*b;return this};this.pushHorizontal=function(a){this.momentum.x+=a;return this};this.pushVertical=
function(a){this.momentum.y+=a;return this};this.scatter=function(a){this.momentum.x=Math.random()*(a- -1*a)+-1*a;this.momentum.y=Math.random()*(a- -1*a)+-1*a;return this};this.pullTo=function(a,b,c){a-=this.x;var d=b-this.y;b=Math.sqrt(a*a+d*d);d=d/b*c;1<b&&(this.pushHorizontal(a/b*c),this.pushVertical(d));return this};this.pullToward=function(a,b){if(!a.deleted){var c=a.x-this.x,d=a.y-this.y,e=Math.sqrt(c*c+d*d),d=d/e*b;1<e&&(this.pushHorizontal(c/e*b),this.pushVertical(d))}return this};this.bounce=
function(a,b,c,d){a||b||c||d||(a=0,b=l.globals.room.width,c=0,d=l.globals.room.height);this.x+this.bound.x<=a?(this.x=a-this.bound.x,this.momentum.x=-this.momentum.x):this.x+this.bound.x+this.bound.width>=b&&(this.x=b-this.bound.width-this.bound.x,this.momentum.x=-this.momentum.x);this.y+this.bound.y<=c?(this.y=c-this.bound.y,this.momentum.y=-this.momentum.y):this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y,this.momentum.y=-this.momentum.y);return this};this.applyPhysics=
function(){this.momentum.x&&this.momentum.y&&(Math.abs(this.momentum.x)>Math.abs(this.momentum.y)?(this.friction.x=this.friction.movement,this.friction.y=Math.abs(this.momentum.y/this.momentum.x*this.friction.movement)):(this.friction.x=Math.abs(this.momentum.x/this.momentum.y*this.friction.movement),this.friction.y=this.friction.movement));0!==this.momentum.x&&(this.moveHorizontal(this.momentum.x),0>this.momentum.x?(this.momentum.x+=this.friction.x,0<this.momentum.x&&(this.momentum.x=0)):0<this.momentum.x&&
(this.momentum.x-=this.friction.x,0>this.momentum.x&&(this.momentum.x=0)));0!==this.momentum.y&&(this.moveVertical(this.momentum.y),0>this.momentum.y?(this.momentum.y+=this.friction.y,0<this.momentum.y&&(this.momentum.y=0)):0<this.momentum.y&&(this.momentum.y-=this.friction.y,0>this.momentum.y&&(this.momentum.y=0)));0!==this.momentum.rotation&&(this.rotation+=this.momentum.rotation,0>this.momentum.rotation?(this.momentum.rotation+=this.friction.rotation,0<this.momentum.rotation&&(this.momentum.rotation=
0)):0<this.momentum.rotation&&(this.momentum.rotation-=this.friction.rotation,0>this.momentum.rotation&&(this.momentum.rotation=0)));return this}};l.finger=function(){this.touching=!1;this.y=this.x=void 0;this.database=[];var a=this;l.globals.dom.addEventListener("touchstart",function(b){a.touches(b)},!1);l.globals.dom.addEventListener("touchmove",function(b){a.touches(b)},!1);l.globals.dom.addEventListener("touchend",function(){a.clearTouches()},!1);l.globals.dom.addEventListener("touchcancel",function(){a.clearTouches()},!1);this.touches=function(a){this.touching=!0;this.x=a.touches[0].clientX;this.y=a.touches[0].clientY;this.database=a.touches};
