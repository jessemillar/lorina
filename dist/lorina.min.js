var accelerometer=new function(){var a=this;this.z=this.y=this.x=0;this.rotation={x:0,y:0,z:0};window.ondeviceorientation=function(b){a.x=b.beta;a.y=b.gamma;a.z=b.alpha};window.ondevicemotion=function(b){b=b.rotationRate;a.rotation.x=b.alpha;a.rotation.y=b.beta;a.rotation.z=b.gamma};this.debug=function(){console.log(Math.round(this.x),Math.round(this.y),Math.round(this.z),Math.round(this.rotation.x),Math.round(this.rotation.y),Math.round(this.rotation.z));return this}};var camera=new function(){this.reset=function(){l.camera.x=0;l.camera.y=0;return this};this.setSandbox=function(a,b){l.camera.sandbox.width=a;l.camera.sandbox.height=b;0>=l.camera.sandbox.width&&(l.camera.sandbox.width=1);0>=l.camera.sandbox.height&&(l.camera.sandbox.height=1);return this};this.follow=function(a,b){if(!a.deleted){if(b&&!b.deleted)var c=a.x<b.x?(b.x-a.x)/2+a.x:(a.x-b.x)/2+b.x,d=a.y<b.y?(b.y-a.y)/2+a.y:(a.y-b.y)/2+b.y;else c=a.x,d=a.y;"resting"==l.camera.state&&(l.camera.sandbox.width&&
...
a.tileset.width/a.tileset.count*c-l.camera.x,b*a.tileset.height-l.camera.y,a.tileset.width/a.tileset.count,a.tileset.height);return this}};var cupboard=new function(){this.save=function(a,b,c){b="object"==typeof b?JSON.stringify(b):b;c?sessionStorage.setItem(a,b):localStorage.setItem(a,b);return!0};this.get=function(a,b){if(b){if(sessionStorage.getItem(a))try{return JSON.parse(sessionStorage.getItem(a))}catch(c){return sessionStorage.getItem(a)}}else if(localStorage.getItem(a))try{return JSON.parse(localStorage.getItem(a))}catch(d){return localStorage.getItem(a)}};this.load=function(a,b,c){this.get(a,c)&&(b?b[a]=this.get(a,c):window[a]=
this.get(a,c))};this["delete"]=function(a,b){if(b){if(sessionStorage.getItem(a))return sessionStorage.removeItem(a),!0}else if(localStorage.getItem(a))return localStorage.removeItem(a),!0;return!1};this.clear=function(a){a?sessionStorage.clear():localStorage.clear();return!0}};var entity=new function(){this.rotation=0;this.sprite={img:new Image};this.previous={x:0,y:0};this.anchor={x:0,y:0};this.bound={x:0,y:0,width:0,height:0};this.debug=function(a){this.deleted||(l.ctx.fillStyle=a?a:"#FF0000",l.ctx.globalAlpha=.5,l.ctx.fillRect(this.x+this.bound.x-l.camera.x,this.y+this.bound.y-l.camera.y,this.bound.width,this.bound.height),l.ctx.fillRect(this.x-2-l.camera.x,this.y-2-l.camera.y,5,5),l.ctx.globalAlpha=1);return this};this["delete"]=function(){this.deleted||(this.deleted=
!0,this.freeze());return this};this.banish=function(a){this.deleted||(a||(a=300),(this.x<-a||this.x>l.room.width+a||this.y<-a||this.y>l.room.height+a)&&this["delete"]());return this};this.setTrait=function(a,b){this[a]=b;return this};this.deleteTrait=function(a){delete this[a];return this};this.setPosition=function(a,b){this.x=a;this.y=b;return this};this.recordDifference=function(a,b){"horizontal"==a?this.previous.x=b:"vertical"==a&&(this.previous.y=b);return this};this.setAnchor=function(a,b){this.anchor=
{x:a,y:b};this.width&&this.height&&this.setBound(0-this.anchor.x,0-this.anchor.y,this.width,this.height);return this};this.setSize=function(a,b,c){this.width=a;this.height=b;c&&this.setBound(this.x,this.y,this.width,this.height);return this};this.setStretch=function(a,b,c,d){this.stretch={width:a,height:b};c&&this.setSize(a,b);d&&this.setBound(0,0,a,b);return this};this.setBound=function(a,b,c,d){this.bound={x:a,y:b,width:c,height:d};return this};this.rotate=function(a){this.rotation+=a;this.fixRotation();
return this};this.rotateTo=function(a){this.rotation=a;this.fixRotation();return this};this.fixRotation=function(){0>this.rotation?this.rotation+=360:360<this.rotation&&(this.rotation-=360);return this};this.steer=function(){this.rotation=180*-Math.atan(this.previous.y/this.previous.x)/Math.PI;0>this.previous.x&&(this.rotation+=180);return this};this.setSprite=function(a,b,c){var d=this;this.sprite.img.onload=function(){d.sprite.width=this.width;d.sprite.height=this.height;(b||void 0==b)&&d.setSize(this.width,
this.height);(c||void 0==c)&&d.setBound(0-d.anchor.x,0-d.anchor.y,this.width,this.height)};this.sprite.img.src=a;return this};this.setAnimation=function(a,b){this.sprite.frame=0;this.sprite.count=a;this.sprite.timer=Math.round(b);var c=this;this.animation=setInterval(function(){c.sprite.frame=c.sprite.frame<c.sprite.count-1?c.sprite.frame+1:0},c.sprite.timer);return this};this.pauseAnimation=function(){this.sprite.animation&&clearInterval(this.sprite.animation);return this};this.setOpacity=function(a){this.opacity=
a;return this};this.fadeOut=function(a){this.opacity=0<this.opacity?this.opacity-a:0;return this};this.fadeIn=function(a){this.opacity=1>this.opacity?this.opacity+a:1;return this};this.buffer=function(){this.deleted||l.zBuffer.push(this);return this};this.flip=function(a){this.flipped=a;return this};this.unflip=function(){"horizontal"==this.flipped?"both"==this.flipped?this.flipped="vertical":delete this.flipped:"vertical"==this.flipped?"both"==this.flipped?this.flipped="vertical":delete this.flipped:
"both"==this.flipped&&delete this.flipped;return this};this.hud=function(){this.drawMode="hud";return this};this.draw=function(){"hud"==this.drawMode?this.cameraY=this.cameraX=0:(this.cameraX=l.camera.x,this.cameraY=l.camera.y);this.deleted||(l.ctx.globalAlpha=this.opacity,this.flipped||this.rotation?(l.ctx.save(),"undefined"!==this.flipped&&("horizontal"==this.flipped?(l.ctx.translate(Math.round(this.x-2*this.anchor.x+this.width-this.cameraX),Math.round(this.y-this.cameraY)),l.ctx.scale(-1,1)):"vertical"==
this.flipped?(l.ctx.translate(Math.round(this.x-this.cameraX),Math.round(this.y-2*this.anchor.y+this.height-this.cameraY)),l.ctx.scale(1,-1)):"both"==this.flipped&&(l.ctx.translate(Math.round(this.x-2*this.anchor.x+this.width-this.cameraX),Math.round(this.y-2*this.anchor.y+this.height-this.cameraY)),l.ctx.scale(-1,-1))),this.rotation&&(l.ctx.translate(Math.round(this.x-this.cameraX),Math.round(this.y-this.cameraY)),l.ctx.rotate(this.rotation*Math.PI/180*-1)),this.stretch?this.sprite.count?l.ctx.drawImage(this.sprite.img,
this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y),this.sprite.width/this.sprite.count,this.sprite.height,this.stretch.width,this.stretch.height):l.ctx.drawImage(this.sprite.img,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y),this.stretch.width,this.stretch.height):this.sprite.count?l.ctx.drawImage(this.sprite.img,this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/
this.sprite.count,this.sprite.height,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y),this.sprite.width/this.sprite.count,this.sprite.height):l.ctx.drawImage(this.sprite.img,Math.round(0-this.anchor.x),Math.round(0-this.anchor.y)),l.ctx.restore()):this.stretch?this.sprite.count?l.ctx.drawImage(this.sprite.img,this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-
this.cameraY),this.sprite.width/this.sprite.count,this.sprite.height,this.stretch.width,this.stretch.height):l.ctx.drawImage(this.sprite.img,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY),this.stretch.width,this.stretch.height):this.sprite.count?l.ctx.drawImage(this.sprite.img,this.sprite.width/this.sprite.count*this.sprite.frame,0,this.sprite.width/this.sprite.count,this.sprite.height,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-
this.cameraY),this.sprite.width/this.sprite.count,this.sprite.height):l.ctx.drawImage(this.sprite.img,Math.round(this.x-this.anchor.x-this.cameraX),Math.round(this.y-this.anchor.y-this.cameraY)));l.ctx.globalAlpha=1;return this};this.snapTo=function(a,b){this.x=a;this.y=b;return this};this.moveHorizontal=function(a){this.recordDifference("horizontal",a);this.x+=a;return this};this.moveVertical=function(a){this.recordDifference("vertical",a);this.y+=a;return this};this.moveTo=function(a,b,c){a-=this.x;
var d=b-this.y;b=Math.sqrt(a*a+d*d);d=d/b*c;1<b&&(this.moveHorizontal(a/b*c),this.moveVertical(d));return this};this.moveToward=function(a,b){if(!a.deleted){var c=a.x-this.x,d=a.y-this.y,e=Math.sqrt(c*c+d*d),d=d/e*b;1<e&&(this.moveHorizontal(c/e*b),this.moveVertical(d))}return this};this.moveTowardDegree=function(a,b){this.moveHorizontal(Math.cos(a*Math.PI/180)*b);this.moveVertical(-Math.sin(a*Math.PI/180)*b);return this};this.contain=function(a,b,c,d){a||b||c||d||(a=0,b=l.room.width,c=0,d=l.room.height);
this.x+this.bound.x<=a?this.x=a-this.bound.x:this.x+this.bound.x+this.bound.width>=b&&(this.x=b-this.bound.width-this.bound.x);this.y+this.bound.y<=c?this.y=c-this.bound.y:this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y);return this};this.setFriction=function(a,b){this.friction=b?{x:0,y:0,movement:a,rotation:b}:{x:0,y:0,movement:a,rotation:a};this.momentum={x:0,y:0,rotation:0};return this};this.freeze=function(){this.momentum={x:0,y:0,rotation:0};this.momentum.rotation=
0;return this};this.spin=function(a){this.momentum.rotation=a;return this};this.pushTowardDegree=function(a,b){this.momentum.x=Math.cos(a*Math.PI/180)*b;this.momentum.y=-Math.sin(a*Math.PI/180)*b;return this};this.pushHorizontal=function(a){this.momentum.x+=a;return this};this.pushVertical=function(a){this.momentum.y+=a;return this};this.scatter=function(a){this.momentum.x=Math.random()*(a- -1*a)+-1*a;this.momentum.y=Math.random()*(a- -1*a)+-1*a;return this};this.pullTo=function(a,b,c){a-=this.x;
...
this.bound.x,this.momentum.x=-this.momentum.x);this.y+this.bound.y<=c?(this.y=c-this.bound.y,this.momentum.y=-this.momentum.y):this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y,this.momentum.y=-this.momentum.y);return this};this.applyPhysics=function(){this.momentum.x&&this.momentum.y&&(Math.abs(this.momentum.x)>Math.abs(this.momentum.y)?(this.friction.x=this.friction.movement,this.friction.y=Math.abs(this.momentum.y/this.momentum.x*this.friction.movement)):(this.friction.x=
Math.abs(this.momentum.x/this.momentum.y*this.friction.movement),this.friction.y=this.friction.movement));0!==this.momentum.x&&(this.moveHorizontal(this.momentum.x),0>this.momentum.x?(this.momentum.x+=this.friction.x,0<this.momentum.x&&(this.momentum.x=0)):0<this.momentum.x&&(this.momentum.x-=this.friction.x,0>this.momentum.x&&(this.momentum.x=0)));0!==this.momentum.y&&(this.moveVertical(this.momentum.y),0>this.momentum.y?(this.momentum.y+=this.friction.y,0<this.momentum.y&&(this.momentum.y=0)):0<
this.momentum.y&&(this.momentum.y-=this.friction.y,0>this.momentum.y&&(this.momentum.y=0)));0!==this.momentum.rotation&&(this.rotation+=this.momentum.rotation,0>this.momentum.rotation?(this.momentum.rotation+=this.friction.rotation,0<this.momentum.rotation&&(this.momentum.rotation=0)):0<this.momentum.rotation&&(this.momentum.rotation-=this.friction.rotation,0>this.momentum.rotation&&(this.momentum.rotation=0)));return this}};var finger=new function(){this.touching=!1;this.y=this.x=void 0;this.database=[];var a=this;l.dom.addEventListener("touchstart",function(b){a.touches(b)},!1);l.dom.addEventListener("touchmove",function(b){a.touches(b)},!1);l.dom.addEventListener("touchend",function(){a.clearTouches()},!1);l.dom.addEventListener("touchcancel",function(){a.clearTouches()},!1);this.touches=function(a){this.touching=!0;this.x=a.touches[0].clientX;this.y=a.touches[0].clientY;this.database=a.touches};this.clearTouches=
function(){this.touching=!1;this.y=this.x=void 0;this.database.length=0};this.checkTouched=function(a){if(0<this.database.length)for(var c=this.database.length;c--;){if(this.x<a.x+a.bound.x+a.bound.width&&this.x>a.x+a.bound.x&&this.y<a.y+a.bound.y+a.bound.height&&this.y>a.y+a.bound.y)return!0;if(c==this.database.length-1)return!1}}};var gamepad=new function(){this.deadzone=0;this.update=function(){l.gamepads=navigator.webkitGetGamepads();var a=l.gamepads[0];a&&(this.p1={buttons:{playstation:a.buttons[16],x:a.buttons[0],circle:a.buttons[1],square:a.buttons[2],triangle:a.buttons[3],l1:a.buttons[4],l2:a.buttons[6],r1:a.buttons[5],r2:a.buttons[7],select:a.buttons[8],start:a.buttons[9],up:a.buttons[12],down:a.buttons[13]},left:a.buttons[14],right:a.buttons[15],joysticks:{left:{horizontal:a.axes[0],vertical:a.axes[1],button:a.buttons[10]},
...
return this};this.freeze=function(){for(var a=this.database.length;a--;)this.database[a].freeze();return this};this.spin=function(a){for(var b=this.database.length;b--;)this.database[b].spin(a);return this};this.pushHorizontal=function(a){for(var b=this.database.length;b--;)this.database[b].pushHorizontal(a);return this};this.pushVertical=function(a){for(var b=this.database.length;b--;)this.database[b].pushVertical(a);return this};this.scatter=function(a){for(var b=this.database.length;b--;)this.database[b].scatter(a);
return this};this.pullTo=function(a,b,c){for(var d=this.database.length;d--;)this.database[d].pullTo(a,b,c);return this};this.pullToward=function(a,b){for(var c=this.database.length;c--;)this.database[c].pullToward(a,b);return this};this.bounce=function(a,b,c,d){for(var e=this.database.length;e--;)this.database[e].bounce(a,b,c,d);return this};this.applyPhysics=function(){for(var a=this.database.length;a--;)this.database[a].applyPhysics();return this}};var keyboard=new function(){var a=this;window.onkeydown=function(){a.pressed(event)};window.onkeyup=function(){a.cancel(event)};this.pressed=function(a){27==a.keyCode&&(this.escape=!0);32==a.keyCode&&(this.space=!0);13==a.keyCode&&(this.enter=!0);16==a.keyCode&&(this.shift=!0);87==a.keyCode&&(this.w=!0);65==a.keyCode&&(this.a=!0);83==a.keyCode&&(this.s=!0);68==a.keyCode&&(this.d=!0);38==a.keyCode&&(this.up=!0);40==a.keyCode&&(this.down=!0);37==a.keyCode&&(this.left=!0);39==a.keyCode&&(this.right=
!0)};this.cancel=function(a){27==a.keyCode&&(this.escape=!1);32==a.keyCode&&(this.space=!1);13==a.keyCode&&(this.enter=!1);16==a.keyCode&&(this.shift=!1);87==a.keyCode&&(this.w=!1);65==a.keyCode&&(this.a=!1);83==a.keyCode&&(this.s=!1);68==a.keyCode&&(this.d=!1);38==a.keyCode&&(this.up=!1);40==a.keyCode&&(this.down=!1);37==a.keyCode&&(this.left=!1);39==a.keyCode&&(this.right=!1)}};var l={},lorina=new function(){var a=this;l.dom=document.createElement("canvas");l.room={};l.zBuffer=[];l.camera={state:"resting",x:0,y:0,previous:{x:0,y:0},sandbox:{width:1,height:1}};l.retina=window.devicePixelRatio;this.setRoomSize=function(a,c){l.room.width=a;l.room.height=c;return this};this.setDomSize=function(a,c){l.dom.width=a;l.dom.height=c;return this};this.setDomPosition=function(a,c){l.dom.style.position="absolute";l.dom.style.left=a+"px";l.dom.style.top=c+"px";return this};this.setTitle=
function(a){document.title=a;return this};this.scale=function(a){l.ctx.imageSmoothingEnabled=!1;l.ctx.scale(a/100,a/100);return this};this.makeFullscreen=function(){document.body.style.background=this.color;window.onresize=function(){a.setFullscreen()};this.setFullscreen();return this};this.setFullscreen=function(){a.setDomPosition(0,0);a.setDomSize(window.innerWidth,window.innerHeight);a.setRoomSize(l.dom.width,l.dom.height)};this.appendCanvas=function(){document.body.appendChild(l.dom);l.ctx=l.dom.getContext("2d")};
this.hideCursor=function(){l.dom.style.cursor="none";return this};this.setRoom=function(a){l.room.current=a;window.requestAnimationFrame(a);return this};this.start=function(a){this.setRoom(a);return this};this.setColor=function(a){this.color=a;return this};this.blank=function(a){l.ctx.fillStyle=a?a:this.color;l.ctx.fillRect(0,0,l.dom.width,l.dom.height);l.zBuffer.length=0;return this};this.draw=function(){l.zBuffer.sort(function(a,b){return a.y-b.y});for(var a=0;a<l.zBuffer.length;a++)l.zBuffer[a].draw();
window.requestAnimationFrame(l.room.current);return this}};var mouse=new function(){var a=this;document.onmouseout=function(){a.mouseOut()};document.onmousemove=function(){a.update()};l.dom.onmousedown=function(){a.clicked()};l.dom.oncontextmenu=function(){event.preventDefault()};l.dom.onmouseup=function(){a.cancel()};this.update=function(){this.actualX=event.clientX-l.dom.offsetLeft;this.actualY=event.clientY-l.dom.offsetTop;this.calculate()};this.calculate=function(){this.x=this.actualX+l.camera.x;this.y=this.actualY+l.camera.y};this.mouseOut=function(){this.y=
...
1;l.ctx.globalAlpha=1;return this};this.fillPie=function(a){100>Math.round(a)?(a=270+3.6*a,360<a&&(a-=360),l.ctx.fillStyle=this.color,l.ctx.beginPath(),l.ctx.moveTo(Math.round(this.x),Math.round(this.y)),l.ctx.arc(Math.round(this.x),Math.round(this.y),this.radius,270*Math.PI/180,a*Math.PI/180),l.ctx.lineTo(Math.round(this.x),Math.round(this.y)),this.opacity&&(l.ctx.globalAlpha=this.opacity),l.ctx.fill(),this.opacity=1,l.ctx.globalAlpha=1):this.fillCircle();return this}};var scissors=new function(){this.mark=function(a,b,c,d){l.ctx.save();l.ctx.beginPath();l.ctx.rect(a,b,c,d);l.ctx.clip();return this};this.cut=function(){l.ctx.restore();return this}};var speaker=new function(){var a=[],b=[];this.load=function(b,d){if(window.cordova){var e=new Media(d);e.name=b;this.cordovaLoad(e)}else e=new Audio,e.name=b,e.src=d,e.preload="auto";a.push(e);return this};this.cordovaLoad=function(a){a.setVolume(0);a.play();a.stop();a.setVolume(1)};this.pause=function(b){for(var d=a.length;d--;)if(a[d].name==b){a[d].pause();break}return this};this.play=function(c){for(var d=a.length;d--;)if(a[d].name==c){window.cordova?(c=new Media(a[d].src),c.name=a[d].name,b.push(c),
b[b.length-1].play({playAudioWhenScreenIsLocked:!1})):(b.push(a[d].cloneNode()),b[b.length-1].play(),b[b.length-1].addEventListener("ended",this.removeAudio(b.length-1)));break}return this};this.removeAudio=function(a){b.splice(a,1)}};var timer=new function(){this.start=function(){this.time=Date.parse(new Date);return this};this.clear=function(){this.time=void 0;return this};this.check=function(){return this.time?Date.parse(new Date)-this.time:0};this.compareTo=function(a){return a.time?this.time>a.time?this.time-a.time:a.time-this.time:0}};var tool=new function(){this.random=function(a,b){return Math.random()*(b-a)+a};this.measureX=function(a,b){return Math.abs(a.x-b.x)};this.measureY=function(a,b){return Math.abs(a.y-b.y)};this.measureDistance=function(a,b){var c=this.measureX(a,b),d=this.measureY(a,b);return Math.sqrt(c*c+d*d)};this.measureAngle=function(a,b){var c=b.x-a.x,d=a.y-b.y,e=180*Math.atan(d/c)/Math.PI;0>c?e+=180:0<c&&0>d&&(e+=360);return e};this.sin=function(a){return Math.sin(a/180*Math.PI)*(180/Math.PI)};this.cos=function(a){return Math.cos(a/
...
b.bound.width&&a.x+a.bound.x+a.bound.width>b.x+b.bound.x&&a.y+a.bound.y<b.y+b.bound.y+b.bound.height&&a.y+a.bound.y+a.bound.height>b.y+b.bound.y?b:!1}};var typewriter=new function(){this.reset=function(){this.textMode=this.color=this.size=this.font=this.style=this.opacity=this.baseline=this.alignment=void 0;return this};this.setOpacity=function(a){this.opacity=a;return this};this.setStyle=function(a){this.style=a;return this};this.setFont=function(a){this.font=a;return this};this.setSize=function(a){this.size=a;return this};this.setAlignment=function(a){this.alignment=a;return this};this.setBaseline=function(a){this.baseline=a;return this};this.setColor=
function(a){this.color=a;return this};this.setPosition=function(a,b){this.x=a;this.y=b;return this};this.write=function(a,b){l.ctx.font=(this.style?this.style:"")+" "+this.size+"px "+(this.font?this.font:"sans-serif");l.ctx.fillStyle=this.color?this.color:"#000000";l.ctx.textAlign=this.alignment?this.alignment:"left";l.ctx.textBaseline="top"==this.baseline?"hanging":"middle"==this.baseline?"middle":"bottom"==this.baseline?"alphabetic":"hanging";this.opacity&&(l.ctx.globalAlpha=this.opacity,this.opacity=
1);b?l.ctx.fillText(a,this.x,this.y):l.ctx.fillText(a,this.x-l.camera.x,this.y-l.camera.y);l.ctx.globalAlpha=1;return this};var a=!1,b=0;this.type=function(c,d){a||(this.key(c,d),a=!0);this.write(c.substr(0,b));return this};this.key=function(a,d){for(var e=0;e<a.length;e++)setTimeout(function(){b++},d*e)};this.pulse=function(a,b){return this}};