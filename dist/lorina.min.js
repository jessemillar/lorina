...
this.color;l.ctx.lineWidth=2*this.stroke;l.ctx.beginPath();l.ctx.rect(Math.round(this.x),Math.round(this.y),Math.round(this.width),Math.round(this.height));this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.stroke();this.opacity=1;l.ctx.globalAlpha=1;return this};this.fillRectangle=function(){l.ctx.fillStyle=this.color;l.ctx.beginPath();l.ctx.rect(Math.round(this.x),Math.round(this.y),Math.round(this.width),Math.round(this.height));this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.fill();this.opacity=
