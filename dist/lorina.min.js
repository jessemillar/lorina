...
a+d*d);d=d/b*c;1<b&&(this.moveHorizontal(a/b*c),this.moveVertical(d));return this};this.moveToward=function(a,b){if(!a.deleted){var c=a.x-this.x,d=a.y-this.y,e=Math.sqrt(c*c+d*d),d=d/e*b;1<e&&(this.moveHorizontal(c/e*b),this.moveVertical(d))}return this};this.moveTowardDegree=function(a,b){this.moveHorizontal(Math.cos(a*Math.PI/180)*b);this.moveVertical(-Math.sin(a*Math.PI/180)*b);return this};this.contain=function(a,b,c,d){a||b||c||d||(a=0,b=l.room.width,c=0,d=l.room.height);this.x+this.bound.x<=
a?this.x=a-this.bound.x:this.x+this.bound.x+this.bound.width>=b&&(this.x=b-this.bound.width-this.bound.x);this.y+this.bound.y<=c?this.y=c-this.bound.y:this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y);return this};this.setFriction=function(a,b){this.friction=b?{x:0,y:0,movement:a,rotation:b}:{x:0,y:0,movement:a,rotation:a};this.momentum={x:0,y:0,rotation:0};return this};this.freeze=function(){this.momentum={x:0,y:0,rotation:0};this.momentum.rotation=0;return this};
this.spin=function(a){this.momentum.rotation=a;return this};this.pushTowardDegree=function(a,b){this.momentum.x=Math.cos(a*Math.PI/180)*b;this.momentum.y=-Math.sin(a*Math.PI/180)*b;return this};this.pushHorizontal=function(a){this.momentum.x+=a;return this};this.pushVertical=function(a){this.momentum.y+=a;return this};this.scatter=function(a){this.momentum.x=Math.random()*(a- -1*a)+-1*a;this.momentum.y=Math.random()*(a- -1*a)+-1*a;return this};this.pullTo=function(a,b,c){a-=this.x;var d=b-this.y;
b=Math.sqrt(a*a+d*d);d=d/b*c;1<b&&(this.pushHorizontal(a/b*c),this.pushVertical(d));return this};this.pullToward=function(a,b){if(!a.deleted){var c=a.x-this.x,d=a.y-this.y,e=Math.sqrt(c*c+d*d),d=d/e*b;1<e&&(this.pushHorizontal(c/e*b),this.pushVertical(d))}return this};this.bounce=function(a,b,c,d){a||b||c||d||(a=0,b=l.room.width,c=0,d=l.room.height);this.x+this.bound.x<=a?(this.x=a-this.bound.x,this.momentum.x=-this.momentum.x):this.x+this.bound.x+this.bound.width>=b&&(this.x=b-this.bound.width-this.bound.x,
this.momentum.x=-this.momentum.x);this.y+this.bound.y<=c?(this.y=c-this.bound.y,this.momentum.y=-this.momentum.y):this.y+this.bound.y+this.bound.height>=d&&(this.y=d-this.bound.height-this.bound.y,this.momentum.y=-this.momentum.y);return this};this.applyPhysics=function(){this.momentum.x&&this.momentum.y&&(Math.abs(this.momentum.x)>Math.abs(this.momentum.y)?(this.friction.x=this.friction.movement,this.friction.y=Math.abs(this.momentum.y/this.momentum.x*this.friction.movement)):(this.friction.x=Math.abs(this.momentum.x/
this.momentum.y*this.friction.movement),this.friction.y=this.friction.movement));0!==this.momentum.x&&(this.moveHorizontal(this.momentum.x),0>this.momentum.x?(this.momentum.x+=this.friction.x,0<this.momentum.x&&(this.momentum.x=0)):0<this.momentum.x&&(this.momentum.x-=this.friction.x,0>this.momentum.x&&(this.momentum.x=0)));0!==this.momentum.y&&(this.moveVertical(this.momentum.y),0>this.momentum.y?(this.momentum.y+=this.friction.y,0<this.momentum.y&&(this.momentum.y=0)):0<this.momentum.y&&(this.momentum.y-=
this.friction.y,0>this.momentum.y&&(this.momentum.y=0)));0!==this.momentum.rotation&&(this.rotation+=this.momentum.rotation,0>this.momentum.rotation?(this.momentum.rotation+=this.friction.rotation,0<this.momentum.rotation&&(this.momentum.rotation=0)):0<this.momentum.rotation&&(this.momentum.rotation-=this.friction.rotation,0>this.momentum.rotation&&(this.momentum.rotation=0)));return this}};var Finger=function(){this.touching=!1;this.y=this.x=void 0;this.database=[];var a=this;l.dom.addEventListener("touchstart",function(b){a.touches(b)},!1);l.dom.addEventListener("touchmove",function(b){a.touches(b)},!1);l.dom.addEventListener("touchend",function(){a.clearTouches()},!1);l.dom.addEventListener("touchcancel",function(){a.clearTouches()},!1);this.touches=function(a){this.touching=!0;this.x=a.touches[0].clientX;this.y=a.touches[0].clientY;this.database=a.touches};this.clearTouches=function(){this.touching=
!1;this.y=this.x=void 0;this.database.length=0};this.checkTouched=function(a){if(0<this.database.length)for(var c=this.database.length;c--;){if(this.x<a.x+a.bound.x+a.bound.width&&this.x>a.x+a.bound.x&&this.y<a.y+a.bound.y+a.bound.height&&this.y>a.y+a.bound.y)return!0;if(c==this.database.length-1)return!1}}};var Gamepad=function(){this.deadzone=0;this.update=function(){l.gamepads=navigator.webkitGetGamepads();var a=l.gamepads[0];a&&(this.p1={buttons:{playstation:a.buttons[16],x:a.buttons[0],circle:a.buttons[1],square:a.buttons[2],triangle:a.buttons[3],l1:a.buttons[4],l2:a.buttons[6],r1:a.buttons[5],r2:a.buttons[7],select:a.buttons[8],start:a.buttons[9],up:a.buttons[12],down:a.buttons[13]},left:a.buttons[14],right:a.buttons[15],joysticks:{left:{horizontal:a.axes[0],vertical:a.axes[1],button:a.buttons[10]},
...
1);b?l.ctx.fillText(a,this.x,this.y):l.ctx.fillText(a,this.x-l.camera.x,this.y-l.camera.y);l.ctx.globalAlpha=1;return this};var a=!1,b=0;this.type=function(c,d){a||(this.key(c,d),a=!0);this.write(c.substr(0,b));return this};this.key=function(a,d){for(var e=0;e<a.length;e++)setTimeout(function(){b++},d*e)}};