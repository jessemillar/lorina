...
l.object.make=function(a,b,c,d,e){l.entities[a]={};l.entities[a].x=b;l.entities[a].y=c;l.entities[a].width=d;l.entities[a].height=e;l.entities[a].rotation=0;l.entities[a].bounding={};l.entities[a].bounding.x=b;l.entities[a].bounding.y=c;l.entities[a].bounding.offset={};l.entities[a].bounding.offset.x=0;l.entities[a].bounding.offset.y=0;l.entities[a].bounding.width=d;l.entities[a].bounding.height=e;l.entities[a].anchor={};l.entities[a].anchor.offset={};l.entities[a].anchor.offset.x=d/2;l.entities[a].anchor.offset.y=
e/2;l.entities[a].anchor.x=b+d/2;l.entities[a].anchor.y=c+e/2;l.entities[a].physics={};l.entities[a].physics.momentum={};l.entities[a].physics.momentum.x=0;l.entities[a].physics.momentum.y=0;l.entities[a].physics.momentum.total=0};l.object.categorize=function(a,b){l.entities[a].category=b};
...
l.tool.measure.total=function(a,b,c){if(l.entities[a]&&l.entities[b]){var d=l.tool.measure.x(a,b);a=l.tool.measure.y(a,b)}else d=l.tool.measure.x(a,b),a=l.tool.measure.y(a,c);return Math.floor(Math.sqrt(d*d+a*a))};l.tool.convert={};l.tool.convert.radian=function(a){return 180*a/Math.PI};l.tool.convert.degree=function(a){return a*Math.PI/180};l.gamecenter={};l.gamecenter.authed=!1;l.gamecenter.enable=function(){l.gamecenter.socket=new Ejecta.GameCenter};l.gamecenter.login={};l.gamecenter.login.soft=function(){l.gamecenter.socket.softAuthenticate(function(a){a?l.debug.gamecenter&&console.log("GameCenter soft login failed"):(l.gamecenter.authed=!0,l.debug.gamecenter&&console.log("GameCenter soft login succeeded"))})};
...
l.entities[l.buffer.database[a].name].height-l.entities.camera.y)),l.ctx.scale(1,-1)):"both"==l.buffer.database[a].flipped&&(l.ctx.translate(Math.round(l.entities[l.buffer.database[a].name].x+l.entities[l.buffer.database[a].name].width-l.entities.camera.x),Math.round(l.entities[l.buffer.database[a].name].y+l.entities[l.buffer.database[a].name].height-l.entities.camera.y)),l.ctx.scale(-1,-1)),0<l.entities[l.buffer.database[a].name].rotation&&(l.ctx.translate(Math.round(l.entities[l.buffer.database[a].name].anchor.x),
Math.round(l.entities[l.buffer.database[a].name].anchor.y)),l.ctx.rotate(l.entities[l.buffer.database[a].name].rotation)),l.entities[l.buffer.database[a].name].animate.count?l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count*l.entities[l.buffer.database[a].name].animate.frame,0,l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height,
Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.x),Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.y),l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height):l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.x),Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.y)),l.ctx.restore()):
0<l.entities[l.buffer.database[a].name].rotation?(l.ctx.save(),l.ctx.translate(Math.round(l.entities[l.buffer.database[a].name].anchor.x-l.entities.camera.x),Math.round(l.entities[l.buffer.database[a].name].anchor.y-l.entities.camera.y)),l.ctx.rotate(l.entities[l.buffer.database[a].name].rotation),l.entities[l.buffer.database[a].name].animate.count?l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count*
l.entities[l.buffer.database[a].name].animate.frame,0,l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height,Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.x),Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.y),l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height):
l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.x),Math.round(0-l.entities[l.buffer.database[a].name].anchor.offset.y)),l.ctx.restore()):l.entities[l.buffer.database[a].name].animate.count?l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count*l.entities[l.buffer.database[a].name].animate.frame,0,l.entities[l.buffer.database[a].name].animate.width/
l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height,Math.round(l.entities[l.buffer.database[a].name].x-l.entities.camera.x),Math.round(l.entities[l.buffer.database[a].name].y-l.entities.camera.y),l.entities[l.buffer.database[a].name].animate.width/l.entities[l.buffer.database[a].name].animate.count,l.entities[l.buffer.database[a].name].animate.height):l.ctx.drawImage(l.entities[l.buffer.database[a].name].sprite,Math.round(l.entities[l.buffer.database[a].name].x-
l.entities.camera.x),Math.round(l.entities[l.buffer.database[a].name].y-l.entities.camera.y)),(l.debug.anchor||l.debug.all)&&l.draw.rectangle(l.entities[l.buffer.database[a].name].anchor.x,l.entities[l.buffer.database[a].name].anchor.y,1,1,"#ffff00"),(l.debug.bounding||l.debug.all)&&l.draw.rectangle(l.entities[l.buffer.database[a].name].x+l.entities[l.buffer.database[a].name].bounding.offset.x,l.entities[l.buffer.database[a].name].y+l.entities[l.buffer.database[a].name].bounding.offset.y,l.entities[l.buffer.database[a].name].bounding.width,
l.entities[l.buffer.database[a].name].bounding.height,"#00ff00",0.5),(l.debug.names||l.debug.all)&&l.write.text(l.buffer.database[a].name,l.entities[l.buffer.database[a].name].x+l.entities[l.buffer.database[a].name].width,l.entities[l.buffer.database[a].name].y,null,null,"#FF0000"),(l.debug.position||l.debug.all)&&l.draw.rectangle(l.entities[l.buffer.database[a].name].x,l.entities[l.buffer.database[a].name].y,1,1,"#0000ff"));l.buffer.database.length=0};
l.draw.hud=function(a,b){if(l.entities[a])b?(l.ctx.save(),"horizontal"==b?(l.ctx.translate(Math.round(l.entities[a].x+l.entities[a].width),Math.round(l.entities[a].y)),l.ctx.scale(-1,1)):"vertical"==b?(l.ctx.translate(Math.round(l.entities[a].x),Math.round(l.entities[a].y+l.entities[a].height)),l.ctx.scale(1,-1)):"both"==b&&(l.ctx.translate(Math.round(l.entities[a].x+l.entities[a].width),Math.round(l.entities[a].y+l.entities[a].height)),l.ctx.scale(-1,-1)),0<l.entities[a].rotation?(l.ctx.translate(Math.round(l.entities[a].anchor.x),
Math.round(l.entities[a].anchor.y)),l.ctx.rotate(l.entities[a].rotation),l.entities[a].animate.count?l.ctx.drawImage(l.entities[a].sprite,l.entities[a].animate.width/l.entities[a].animate.count*l.entities[a].animate.frame,0,l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height,Math.round(0-l.entities[a].anchor.offset.x),Math.round(0-l.entities[a].anchor.offset.y),l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height):l.ctx.drawImage(l.entities[a].sprite,
Math.round(0-l.entities[a].anchor.offset.x),Math.round(0-l.entities[a].anchor.offset.y))):l.entities[a].animate.count?l.ctx.drawImage(l.entities[a].sprite,l.entities[a].animate.width/l.entities[a].animate.count*l.entities[a].animate.frame,0,l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height,0,0,l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height):l.ctx.drawImage(l.entities[a].sprite,0,0),l.ctx.restore()):0<l.entities[a].rotation?(l.ctx.save(),
l.ctx.translate(Math.round(l.entities[a].anchor.x),Math.round(l.entities[a].anchor.y)),l.ctx.rotate(l.entities[a].rotation),l.entities[a].animate.count?l.ctx.drawImage(l.entities[a].sprite,l.entities[a].animate.width/l.entities[a].animate.count*l.entities[a].animate.frame,0,l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height,Math.round(0-l.entities[a].anchor.offset.x),Math.round(0-l.entities[a].anchor.offset.y),l.entities[a].animate.width/l.entities[a].animate.count,
l.entities[a].animate.height):l.ctx.drawImage(l.entities[a].sprite,Math.round(0-l.entities[a].anchor.offset.x),Math.round(0-l.entities[a].anchor.offset.y)),l.ctx.restore()):l.entities[a].animate.count?l.ctx.drawImage(l.entities[a].sprite,l.entities[a].animate.width/l.entities[a].animate.count*l.entities[a].animate.frame,0,l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height,Math.round(l.entities[a].x),Math.round(l.entities[a].y),l.entities[a].animate.width/l.entities[a].animate.count,
...
l.physics.bounce=function(a,b,c,d,e){b||c||d||e||(b=0,c=l.canvas.width,d=0,e=l.canvas.height);if(l.entities[a])l.entities[a].x+l.entities[a].bounding.offset.x<=b?(l.entities[a].x=b-l.entities[a].bounding.offset.x,l.entities[a].physics.momentum.x=-l.entities[a].physics.momentum.x):l.entities[a].x+l.entities[a].bounding.offset.x+l.entities[a].bounding.width>=c&&(l.entities[a].x=c-l.entities[a].bounding.width-(l.entities[a].width-l.entities[a].bounding.offset.x-l.entities[a].bounding.width),l.entities[a].physics.momentum.x=
-l.entities[a].physics.momentum.x),l.entities[a].y+l.entities[a].bounding.offset.y<=d?(l.entities[a].y=d-l.entities[a].bounding.offset.y,l.entities[a].physics.momentum.y=-l.entities[a].physics.momentum.y):l.entities[a].y+l.entities[a].bounding.offset.y+l.entities[a].bounding.height>=e&&(l.entities[a].y=e-l.entities[a].bounding.height-(l.entities[a].height-l.entities[a].bounding.offset.y-l.entities[a].bounding.height),l.entities[a].physics.momentum.y=-l.entities[a].physics.momentum.y);else for(var f in l.entities)l.entities[f].category==
a&&l.physics.bounce(f,b,c,d,e)};l.preloader={};l.preloader.calculate=function(){l.preloader.percent=Math.round(100*(1-l.preloader.count/l.preloader.total))};l.preloader.queue=function(){l.preloader.count?(l.preloader.total+=1,l.preloader.count+=1):(l.preloader.total=1,l.preloader.count=1);l.preloader.calculate()};l.preloader.update=function(){l.preloader.count?(l.preloader.count-=1,l.preloader.calculate(),0==l.preloader.count&&l.change.screen(l.screen.engine.start)):l.change.screen(l.screen.engine.start)};l.write={};l.write.hud=function(a,b,c,d,e,f,g){l.ctx.font=d?(e+"px "+d).toString():"10px sans-serif";l.ctx.fillStyle=f?f:"#000000";g?"left"==g?l.ctx.textAlign="left":"right"==g?l.ctx.textAlign="right":"center"==g&&(l.ctx.textAlign="center"):l.ctx.textAlign="left";e?l.ctx.fillText(a,b,c+e):l.ctx.fillText(a,b,c+10)};
