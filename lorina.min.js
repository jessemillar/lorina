...
l.game.start=function(){l.game.loop=setInterval(l.game.loading,1E3/60)};l.game.stop=function(){clearInterval(l.game.loop)};l.screen={};l.screen.change={};l.screen.change.loading=function(){clearInterval(l.game.loop);l.game.state="loading";l.game.loop=setInterval(l.screen.loading,1E3/60)};l.screen.change.menu=function(){clearInterval(l.game.loop);l.game.state="menu";l.game.loop=setInterval(l.screen.menu,1E3/60)};
l.screen.change.game=function(){clearInterval(l.game.loop);l.game.state="game";l.game.loop=setInterval(l.screen.game,1E3/60)};l.screen.change.gameover=function(){clearInterval(l.game.loop);l.game.state="gameover";l.game.loop=setInterval(l.screen.gameover,1E3/60)};l.screen.change.paused=function(){clearInterval(l.game.loop);l.game.state="paused";l.game.loop=setInterval(l.screen.paused,1E3/60)};l.camera={};
...
l.entities.camera.width&&(l.entities.camera.x+=a):0<l.entities.camera.x-Math.abs(a)&&(l.entities.camera.x-=Math.abs(a));0<b?l.entities.camera.y+b<l.canvas.height-l.entities.camera.height&&(l.entities.camera.y+=b):0<l.entities.camera.y-Math.abs(b)&&(l.entities.camera.y-=Math.abs(b))},d*e);setTimeout(function(){l.entities.camera.following&&(l.entities.camera.shaking=!1)},b)};l.tool={};l.tool.random=function(a,b){return Math.random()*(b-a)+a};l.tool.count={};
l.tool.count.all=function(){var a=0,b;for(b in l.entities)a++;return a};l.tool.count.prototype=function(a){var b=0,c;for(c in l.entities)l.entities[c].prototype==a&&b++;return b};l.tool.count.category=function(a){var b=0,c;for(c in l.entities)l.entities[c].category==a&&b++;return b};l.tool.measure={};l.tool.measure.x=function(a,b){return l.entities[a]&&l.entities[b]?Math.floor(Math.abs(l.entities[a].anchor.x-l.entities[b].anchor.x)):Math.floor(Math.abs(l.entities[a].anchor.x-b))};
l.tool.measure.y=function(a,b){return l.entities[a]&&l.entities[b]?Math.floor(Math.abs(l.entities[a].anchor.y-l.entities[b].anchor.y)):Math.floor(Math.abs(l.entities[a].anchor.y-b))};l.tool.measure.total=function(a,b,c){if(l.entities[a]&&l.entities[b]){var d=l.tool.measure.x(a,b);a=l.tool.measure.y(a,b)}else d=l.tool.measure.x(a,b),a=l.tool.measure.y(a,c);return Math.floor(Math.sqrt(d*d+a*a))};l.tool.convert={};l.tool.convert.radian=function(a){return 180*a/Math.PI};
l.tool.convert.degree=function(a){return a*Math.PI/180};l.audio={};l.audio.files={};l.audio.make=function(a,b){l.preloader.queue();l.audio.files[a]=document.createElement("audio");l.audio.files[a].src=b;l.audio.files[a].canPlay=!0;"ejecta"==l.canvas.agent?(l.audio.files[a].preload=!0,l.audio.files[a].load(),document.body.appendChild(l.audio.files[a]),l.audio.files[a].addEventListener("canplaythrough",function(){l.preloader.update()})):(l.audio.files[a].setAttribute("preload","auto"),l.audio.files[a].onloadeddata=function(){l.preloader.update()})};
...
l.audio.loop=function(a){l.audio.files[a].canPlay&&!l.audio.mute&&("chrome"==l.canvas.agent&&l.audio.files[a].load(),l.audio.files[a].addEventListener("ended",function(){l.audio.files[a].currentTime=0;l.audio.files[a].play()},!1),l.audio.files[a].play(),l.audio.files[a].canPlay=!1)};l.entities={};l.object={};l.object.last={};
...
l.object["delete"]=function(a){if(l.entities[a])delete l.entities[a];else for(var b in l.entities)l.entities[b].category==a&&l.object["delete"](b)};
...
l.prototype.update=function(a){l.prototype.entities[a].anchor.x=l.prototype.entities[a].anchor.offset.x;l.prototype.entities[a].anchor.y=l.prototype.entities[a].anchor.offset.y;l.prototype.entities[a].bounding.x=l.prototype.entities[a].bounding.offset.x;l.prototype.entities[a].bounding.y=l.prototype.entities[a].bounding.offset.y};l.buffer={};l.buffer.database=[];l.buffer.object=function(a,b){if(l.entities[a]){var c={};c.name=a;c.y=l.entities[a].anchor.y;c.flipped=b;l.buffer.database.push(c)}else for(c in l.entities)l.entities[c].category==a&&l.buffer.object(c,b)};l.draw={};l.draw.blank=function(a){l.ctx.fillStyle=a?a:l.entities.camera.color;l.ctx.fillRect(0,0,l.entities.camera.width,l.entities.camera.height)};
...
l.entities[a].animate.height,Math.round(l.entities[a].x),Math.round(l.entities[a].y),l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height):l.ctx.drawImage(l.entities[a].sprite,Math.round(l.entities[a].x),Math.round(l.entities[a].y));else for(var c in l.entities)l.entities[c].category==a&&l.draw.hud(c,b)};l.preloader={};l.preloader.calculate=function(){l.preloader.percent=Math.round(100*(1-l.preloader.count/l.preloader.total))};l.preloader.queue=function(){l.preloader.count?(l.preloader.total+=1,l.preloader.count+=1):(l.preloader.total=1,l.preloader.count=1);l.preloader.calculate()};l.preloader.update=function(){l.preloader.count-=1;l.preloader.calculate();0==l.preloader.count&&l.screen.change.menu()};l.write={};l.write.hud=function(a,b,c,d,e,f,g){l.ctx.fillStyle=f?f:"#000000";d&&(l.ctx.font=(e+"px "+d).toString());g?"left"==g?l.ctx.textAlign="left":"right"==g?l.ctx.textAlign="right":"center"==g&&(l.ctx.textAlign="center"):l.ctx.textAlign="left";e?l.ctx.fillText(a,b,c+e):l.ctx.fillText(a,b,c+10)};
l.write.text=function(a,b,c,d,e,f,g){l.ctx.fillStyle=f?f:"#000000";d&&(l.ctx.font=(e+"px "+d).toString());g?"left"==g?l.ctx.textAlign="left":"right"==g?l.ctx.textAlign="right":"center"==g&&(l.ctx.textAlign="center"):l.ctx.textAlign="left";e?l.ctx.fillText(a,b-l.entities.camera.x,c+e-l.entities.camera.y):l.ctx.fillText(a,b-l.entities.camera.x,c+10-l.entities.camera.y)};l.collision=function(a,b,c,d){d||l.quad.divide();if(l.entities[a]&&l.entities[b])for(e in d=l.quad.locate(a),d){if(d[e]==b)if(l.entities[a].bounding.x<l.entities[b].bounding.x+l.entities[b].bounding.width&&l.entities[a].bounding.x+l.entities[a].bounding.width>l.entities[b].bounding.x&&l.entities[a].bounding.y<l.entities[b].bounding.y+l.entities[b].bounding.height&&l.entities[a].bounding.y+l.entities[a].bounding.height>l.entities[b].bounding.y)if(c){eval(c);break}else return!0;else return!1}else if(l.entities[a])for(var e in l.entities)l.entities[e].category==
b&&l.collision(a,e,c,!0);else if(l.entities[b])for(e in l.entities)l.entities[e].category==a&&l.collision(e,b,c,!0);else for(e in l.entities)if(l.entities[e].category==a){d=l.quad.locate(e);for(var f in d)l.entities[d[f]]&&l.entities[d[f]].category==b&&l.collision(e,d[f],c,!0)}};l.quad={};
l.quad.divide=function(){l.quad.depth||(l.quad.depth=Math.floor(l.tool.count.all()/5));if(l.quad.leaf)for(var a=0;a<l.quad.leaf.count;a++)l.quad.leaf["id"+a]&&(l.quad.leaf["id"+a].length=0);else l.quad.leaf={},l.quad.leaf.count=l.quad.depth*l.quad.depth,l.quad.leaf.width=Math.floor(l.canvas.width/l.quad.depth),l.quad.leaf.height=Math.floor(l.canvas.height/l.quad.depth);for(a in l.entities){var b=Math.floor(l.entities[a].anchor.y/l.quad.leaf.height)*l.quad.depth+Math.floor(l.entities[a].anchor.x/l.quad.leaf.width);
l.quad.leaf["id"+b]?l.quad.leaf["id"+b][l.quad.leaf["id"+b].length]=a:l.quad.leaf["id"+b]=[];l.entities[a].leaf=b}};
l.quad.locate=function(a){return 0>l.entities[a].leaf-l.quad.depth?l.quad.leaf["id"+l.entities[a].leaf].concat(l.quad.leaf["id"+(l.entities[a].leaf-1)],l.quad.leaf["id"+(l.entities[a].leaf+1)],l.quad.leaf["id"+(l.entities[a].leaf+l.quad.depth-1)],l.quad.leaf["id"+(l.entities[a].leaf+l.quad.depth)],l.quad.leaf["id"+(l.entities[a].leaf+l.quad.depth+1)]):l.entities[a].leaf+l.quad.depth>l.quad.leaf.count?l.quad.leaf["id"+l.entities[a].leaf].concat(l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth-1)],
l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth)],l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth+1)],l.quad.leaf["id"+(l.entities[a].leaf-1)],l.quad.leaf["id"+(l.entities[a].leaf+1)]):l.quad.leaf["id"+l.entities[a].leaf].concat(l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth-1)],l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth)],l.quad.leaf["id"+(l.entities[a].leaf-l.quad.depth+1)],l.quad.leaf["id"+(l.entities[a].leaf-1)],l.quad.leaf["id"+(l.entities[a].leaf+1)],l.quad.leaf["id"+(l.entities[a].leaf+
l.quad.depth-1)],l.quad.leaf["id"+(l.entities[a].leaf+l.quad.depth)],l.quad.leaf["id"+(l.entities[a].leaf+l.quad.depth+1)])};l.move={};l.move.snap=function(a,b,c){if(l.entities[a])l.entities[a].x=l.entities[a].anchor.offset.x?b-l.entities[a].anchor.offset.x:b,l.entities[a].y=l.entities[a].anchor.offset.y?c-l.entities[a].anchor.offset.y:c,l.object.update(a);else for(var d=Object.keys(l.entities),e=0;e<d.length;e++)l.entities[d[e]].category==a&&l.move.snap(d[e],b,c)};
