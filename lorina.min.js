...
l.screen.change.settings=function(){clearInterval(l.game.loop);l.game.state="settings";l.game.loop=setInterval(l.screen.settings,1E3/60)};l.screen.change.credits=function(){clearInterval(l.game.loop);l.game.state="credits";l.game.loop=setInterval(l.screen.credits,1E3/60)};l.screen.change.game=function(){clearInterval(l.game.loop);l.game.state="game";l.game.loop=setInterval(l.screen.game,1E3/60)};
l.screen.change.gameover=function(){clearInterval(l.game.loop);l.game.state="gameover";l.game.loop=setInterval(l.screen.gameover,1E3/60)};l.screen.change.paused=function(){clearInterval(l.game.loop);l.game.state="paused";l.game.loop=setInterval(l.screen.paused,1E3/60)};l.camera={};
...
l.write.text=function(a,b,c,d,e,f,g){l.ctx.fillStyle=f?f:"#000000";d&&(l.ctx.font=(e+"px "+d).toString());g?"left"==g?l.ctx.textAlign="left":"right"==g?l.ctx.textAlign="right":"center"==g&&(l.ctx.textAlign="center"):l.ctx.textAlign="left";e?l.ctx.fillText(a,b-l.entities.camera.x,c+e-l.entities.camera.y):l.ctx.fillText(a,b-l.entities.camera.x,c+10-l.entities.camera.y)};l.collision=function(a,b,c){if(l.entities[a]&&l.entities[b])if(l.entities[a].bounding.x<l.entities[b].bounding.x+l.entities[b].bounding.width&&l.entities[a].bounding.x+l.entities[a].bounding.width>l.entities[b].bounding.x&&l.entities[a].bounding.y<l.entities[b].bounding.y+l.entities[b].bounding.height&&l.entities[a].bounding.y+l.entities[a].bounding.height>l.entities[b].bounding.y)if(c)eval(c);else return!0;else return!1;else if(l.entities[a])for(var d in l.entities)l.entities[d].category==b&&l.collision(a,
d,c);else if(l.entities[b])for(d in l.entities)l.entities[d].category==a&&l.collision(d,b,c);else for(d in l.entities)if(l.entities[d].category==a)for(var e in l.entities)l.entities[e].category==b&&l.collision(d,e,c)};l.move={};l.move.snap=function(a,b,c){if(l.entities[a])l.entities[a].x=l.entities[a].anchor.offset.x?b-l.entities[a].anchor.offset.x:b,l.entities[a].y=l.entities[a].anchor.offset.y?c-l.entities[a].anchor.offset.y:c,l.object.update(a);else for(var d=Object.keys(l.entities),e=0;e<d.length;e++)l.entities[d[e]].category==a&&l.move.snap(d[e],b,c)};
