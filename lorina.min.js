...
Math.PI);this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.stroke();l.ctx.globalAlpha=1;return this};this.fillCircle=function(){l.ctx.fillStyle=this.color;l.ctx.beginPath();l.ctx.arc(Math.round(this.x),Math.round(this.y),this.radius,0,2*Math.PI);this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.fill();l.ctx.globalAlpha=1;return this};this.strokeArc=function(){l.ctx.strokeStyle=this.color;l.ctx.lineWidth=this.stroke;l.ctx.beginPath();l.ctx.arc(Math.round(this.x),Math.round(this.y),this.radius,
this.start*Math.PI/180,this.stop*Math.PI/180);this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.stroke();l.ctx.globalAlpha=1;return this};this.fillArc=function(){l.ctx.fillStyle=this.color;l.ctx.beginPath();l.ctx.arc(Math.round(this.x),Math.round(this.y),this.radius,this.start*Math.PI/180,this.stop*Math.PI/180);this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.fill();l.ctx.globalAlpha=1;return this};this.strokeRectangle=function(){l.ctx.strokeStyle=this.color;l.ctx.lineWidth=this.stroke;l.ctx.beginPath();
l.ctx.rect(Math.round(this.x),Math.round(this.y),Math.round(this.width),Math.round(this.height));this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.stroke();l.ctx.globalAlpha=1;return this};this.fillRectangle=function(){l.ctx.fillStyle=this.color;l.ctx.beginPath();l.ctx.rect(Math.round(this.x),Math.round(this.y),Math.round(this.width),Math.round(this.height));this.opacity&&(l.ctx.globalAlpha=this.opacity);l.ctx.fill();l.ctx.globalAlpha=1;return this};this.fillPie=function(a){100>Math.round(a)?(a=
270+3.6*a,360<a&&(a-=360),l.ctx.fillStyle=this.color,l.ctx.beginPath(),l.ctx.moveTo(Math.round(this.x),Math.round(this.y)),l.ctx.arc(Math.round(this.x),Math.round(this.y),this.radius,270*Math.PI/180,a*Math.PI/180),l.ctx.lineTo(Math.round(this.x),Math.round(this.y)),this.opacity&&(l.ctx.globalAlpha=this.opacity),l.ctx.fill(),this.opacity&&(l.ctx.globalAlpha=1)):this.fillCircle();return this}};var Speaker=function(){this.file=new Audio;this.setFile=function(a){this.file.src=a;return this};this.pause=function(){this.file.pause();return this};this.play=function(){this.file.play();var a=this;this.file.onended=function(){a.file.currentTime=0};return this};this.loop=function(){this.file.loop=!0;this.file.play();return this}};var Timer=function(){this.log=function(){this.time=new Date;return this};this.check=function(a){return(new Date).getTime()-a.time.getTime()};this.compareTo=function(a){return a.time?this.time.getTime()>a.time.getTime()?this.time.getTime()-a.time.getTime():a.time.getTime()-this.time.getTime():0}};var Tool=function(){this.random=function(a,b){return Math.random()*(b-a)+a};this.measureX=function(a,b){return Math.abs(a.x-b.x)};this.measureY=function(a,b){return Math.abs(a.y-b.y)};this.measureDistance=function(a,b){var c=this.measureX(a,b),d=this.measureY(a,b);return Math.sqrt(c*c+d*d)};this.measureAngle=function(a,b){var c=b.x-a.x,d=a.y-b.y,e=180*Math.atan(d/c)/Math.PI;0>c?e+=180:0<c&&0>d&&(e+=360);return e}};var Typewriter=function(){this.setOpacity=function(a){this.opacity=a;return this};this.setStyle=function(a){this.style=a;return this};this.setFont=function(a){this.font=a;return this};this.setSize=function(a){this.size=a;return this};this.setAlignment=function(a){this.alignment=a;return this};this.setColor=function(a){this.color=a;return this};this.hud=function(){this.textMode="hud";return this};this.setPosition=function(a,b){this.x=a;this.y=b;return this};this.write=function(a){var b=this.style?
this.style:"";if(this.size){var e=this.size;this.y+=this.size}else e=10,this.y+=10;l.ctx.font=b+" "+e+"px "+(this.font?this.font:"sans-serif");l.ctx.fillStyle=this.color?this.color:"#000000";l.ctx.textAlign=this.alignment?this.alignment:"left";this.opacity&&(l.ctx.globalAlpha=this.opacity,this.opacity=1);this.print(a);l.ctx.globalAlpha=1;return this};this.print=function(a){"hud"==this.textMode?l.ctx.fillText(a,this.x,this.y):l.ctx.fillText(a,this.x-l.camera.x,this.y-l.camera.y);this.textMode="world"};
var a=!1,b=0;this.type=function(c,d){a||(this.key(c,d),a=!0);this.write(c.substr(0,b));return this};this.key=function(a,d){for(var e=0;e<a.length;e++)setTimeout(function(){b++},d*e)}};