...
function(a){this.loop&&clearInterval(this.loop);this.loop=setInterval(a,1E3/60);return this};this.setColor=function(a){this.color=a;return this};this.blank=function(a){l.ctx.fillStyle=a?a:this.color;l.ctx.fillRect(0,0,l.dom.width,l.dom.height);l.buffer.length=0;return this};this.draw=function(){l.buffer.sort(function(a,c){return a.y-c.y});for(var a=l.buffer.length;a--;)l.buffer[a].draw();return this};this.checkSolid=function(a,b){var c=this.checkCollision(a,b);c&&(a.previous.y+a.bound.y+a.bound.height<=
c.y+c.bound.y?a.y=c.y+c.bound.y-a.anchor.y:a.previous.y+a.bound.y>=c.y+c.bound.y+c.bound.height?a.y=c.y+c.bound.y+c.bound.height+a.anchor.y:a.previous.x+a.bound.x+a.bound.width<c.x?a.x=c.x+c.bound.x-a.anchor.x:a.previous.x+a.bound.x>c.x&&(a.x=c.x+c.bound.x+c.bound.width+a.anchor.x));return this};this.checkCollision=function(a,b){if(a.deleted)return!1;if(b.database){for(var c=b.database.length;c--;)if(!b.database[c].deleted&&a.x+a.bound.x<b.database[c].x+b.database[c].bound.x+b.database[c].bound.width&&
