...
this.style:"";if(this.size){var c=this.size;this.y+=this.size}else c=10,this.y+=10;l.ctx.font=b+" "+c+"px "+(this.font?this.font:"sans-serif");l.ctx.fillStyle=this.color?this.color:"#000000";l.ctx.textAlign=this.alignment?this.alignment:"left";this.opacity&&(l.ctx.globalAlpha=this.opacity);"hud"==this.textMode?l.ctx.fillText(a,this.x,this.y):l.ctx.fillText(a,this.x-l.camera.x,this.y-l.camera.y);l.ctx.globalAlpha=1;this.textMode="world";return this}};