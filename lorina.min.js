...
l.tool.measure.total=function(a,b,c){if(l.entities[a]&&l.entities[b]){var d=l.tool.measure.x(a,b);a=l.tool.measure.y(a,b)}else d=l.tool.measure.x(a,b),a=l.tool.measure.y(a,c);return Math.floor(Math.sqrt(d*d+a*a))};l.tool.convert={};l.tool.convert.radian=function(a){return 180*a/Math.PI};l.tool.convert.degree=function(a){return a*Math.PI/180};l.gamecenter={};l.game.gamecenter&&(l.gamecenter.socket=new Ejecta.GameCenter);l.gamecenter.authed=!1;l.gamecenter.login={};l.gamecenter.login.soft=function(){l.gamecenter.socket.softAuthenticate(function(a){a?l.debug.gamecenter&&console.log("GameCenter soft login failed"):(l.gamecenter.authed=!0,l.debug.gamecenter&&console.log("GameCenter soft login succeeded"))})};
