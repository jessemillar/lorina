...
l.camera.x,l.camera.previous.y=l.camera.y);l.camera.state="shaking";c/=2*a;for(var d=0;d<2*a;d++)this.milkshake(d,c,b);return this};this.milkshake=function(a,b,c){setTimeout(function(){l.camera.state="shaking";var a=0-c/2,b=c/2,f=Math.random()*(b-a)+a,a=Math.random()*(b-a)+a;l.camera.x=0<f?l.camera.x+f:l.camera.x-Math.abs(f);l.camera.y=0<a?l.camera.y+a:l.camera.y-Math.abs(a)},a*b);setTimeout(function(){l.camera.state="resting";l.camera.x=l.camera.previous.x;l.camera.y=l.camera.previous.y},a*b+b/2)}};var Entity=function(){this.y=this.x=0;this.previous={x:0,y:0};this.degree=this.height=this.width=0;this.anchor={x:0,y:0};this.bound={x:0,y:0,width:0,height:0};this.sprite={img:new Image};this.debug=function(a){this.deleted||(l.ctx.fillStyle=a?a:"#FF0000",l.ctx.globalAlpha=0.5,l.ctx.fillRect(this.x+this.bound.x-l.camera.x,this.y+this.bound.y-l.camera.y,this.bound.width,this.bound.height),l.ctx.fillRect(this.x-2-l.camera.x,this.y-2-l.camera.y,5,5),l.ctx.globalAlpha=1);return this};this["delete"]=function(){this.deleted=
