...
this.friction.y,0<this.momentum.y&&(this.momentum.y=0)):0<this.momentum.y&&(this.momentum.y-=this.friction.y,0>this.momentum.y&&(this.momentum.y=0)));0!==this.momentum.rotation&&(this.degree+=this.momentum.rotation,0>this.momentum.rotation?(this.momentum.rotation+=this.friction.rotation,0<this.momentum.rotation&&(this.momentum.rotation=0)):0<this.momentum.rotation&&(this.momentum.rotation-=this.friction.rotation,0>this.momentum.rotation&&(this.momentum.rotation=0)));return this}};var Finger=function(){this.database=[];var a=this;document.touchstart=function(b){a.touches(b)};document.touchmove=function(b){a.touches(b)};document.touchend=function(b){a.touches(b)};document.touchcancel=function(b){a.touches(b)};this.touches=function(a){a?this.database=a.touches:this.database.length=0};this.checkTouched=function(a){if(0<this.database.length)for(var c=this.database.length;c--;){if(this.database[c].pageX<a.bound.x+a.bound.width&&this.database[c].pageX>a.bound.x&&this.database[c].pageY<
