...
c.y+c.bound.y?a.y=c.y+c.bound.y-(a.bound.height+a.bound.y):a.previous.y+a.bound.y>=c.y+c.bound.y+c.bound.height?a.y=c.y+c.bound.y+c.bound.height-a.bound.y:a.previous.x+a.bound.x+a.bound.width<c.x?a.x=c.x+c.bound.x-(a.bound.width+a.bound.x):a.previous.x+a.bound.x>c.x&&(a.x=c.x+c.bound.x+c.bound.width-a.bound.x));return this};this.checkCollision=function(a,b){if(a.deleted)return!1;if(b.database){for(var c=b.database.length;c--;)if(!b.database[c].deleted&&a.x+a.bound.x<b.database[c].x+b.database[c].bound.x+
