var l={game:{},debug:{}};
l.game.setup=function(a,b){b&&(document.body.style.background=a);l.dom=document.getElementById("canvas");l.ctx=document.getElementById("canvas").getContext("2d");b&&(l.game.fullscreen(),document.body.setAttribute("onresize","l.game.fullscreen()"));l.canvas={};l.canvas.width=l.dom.width;l.canvas.height=l.dom.height;window.navigator.vendor?"Google Inc."==window.navigator.vendor&&(l.canvas.agent="chrome"):l.canvas.agent="ejecta";l.object.make("camera",0,0,l.canvas.width,l.canvas.height);l.entities.camera.color=
a;l.entities.camera.previous={};l.entities.camera.previous.x=l.entities.camera.x;l.entities.camera.previous.y=l.entities.camera.y};l.game.fullscreen=function(){l.dom.style.position="absolute";l.dom.style.left="0px";l.dom.style.top="0px";l.dom.width=window.innerWidth;l.dom.height=window.innerHeight;l.canvas&&(l.canvas.width=l.dom.width,l.canvas.height=l.dom.height);l.entities.camera&&(l.entities.camera.width=l.dom.width,l.entities.camera.height=l.dom.height)};
...
l.entities.camera.width&&(l.entities.camera.x+=a):0<l.entities.camera.x-Math.abs(a)&&(l.entities.camera.x-=Math.abs(a));0<b?l.entities.camera.y+b<l.canvas.height-l.entities.camera.height&&(l.entities.camera.y+=b):0<l.entities.camera.y-Math.abs(b)&&(l.entities.camera.y-=Math.abs(b))},c*e);setTimeout(function(){l.entities.camera.following&&(l.entities.camera.shaking=!1)},b)};l.tools={};l.tools.random=function(a,b){return Math.random()*(b-a)+a};l.measure={};
l.measure.x=function(a,b){return l.entities[a]&&l.entities[b]?Math.floor(Math.abs(l.entities[a].anchor.x-l.entities[b].anchor.x)):Math.floor(Math.abs(l.entities[a].anchor.x-b))};l.measure.y=function(a,b){return l.entities[a]&&l.entities[b]?Math.floor(Math.abs(l.entities[a].anchor.y-l.entities[b].anchor.y)):Math.floor(Math.abs(l.entities[a].anchor.y-b))};
l.measure.total=function(a,b,d){if(l.entities[a]&&l.entities[b]){var c=l.measure.x(a,b);a=l.measure.y(a,b)}else c=l.measure.x(a,b),a=l.measure.y(a,d);return Math.floor(Math.sqrt(c*c+a*a))};l.audio={};l.audio.files={};l.audio.make=function(a,b){l.preloader.queue();l.audio.files[a]=document.createElement("audio");l.audio.files[a].src=b;l.audio.files[a].canPlay=!0;"ejecta"==l.canvas.agent?(l.audio.files[a].preload=!0,l.audio.files[a].load(),document.body.appendChild(l.audio.files[a]),l.audio.files[a].addEventListener("canplaythrough",function(){l.preloader.update()})):(l.audio.files[a].setAttribute("preload","auto"),l.audio.files[a].onloadeddata=function(){l.preloader.update()})};
l.audio.pause=function(a){l.audio.files[a].pause()};l.audio.rewind=function(a){l.audio.files[a].canPlay=!0};l.audio.play=function(a){l.audio.files[a].canPlay&&("chrome"==l.canvas.agent&&l.audio.files[a].load(),l.audio.files[a].play(),l.audio.files[a].canPlay=!1)};l.audio.loop=function(a){l.audio.files[a].canPlay&&("chrome"==l.canvas.agent&&l.audio.files[a].load(),l.audio.files[a].play(),l.audio.files[a].canPlay=!1)};l.entities={};l.object={};
l.object.from=function(a,b,d){var c=l.prototype.count(a);console.log(a+c);l.prototype.entities[a]&&(l.entities[a+c]={},l.entities[a+c].prototype=a,l.entities[a+c].x=b-l.prototype.entities[a].anchor.offset.x,l.entities[a+c].y=d-l.prototype.entities[a].anchor.offset.y,l.entities[a+c].width=l.prototype.entities[a].width,l.entities[a+c].height=l.prototype.entities[a].height,l.entities[a+c].bounding={},l.entities[a+c].bounding.x=b,l.entities[a+c].bounding.y=d,l.entities[a+c].bounding.offset={},l.entities[a+
c].bounding.offset.x=l.prototype.entities[a].bounding.offset.x,l.entities[a+c].bounding.offset.y=l.prototype.entities[a].bounding.offset.y,l.entities[a+c].bounding.width=l.prototype.entities[a].width,l.entities[a+c].bounding.height=l.prototype.entities[a].height,l.entities[a+c].anchor={},l.entities[a+c].anchor.offset={},l.entities[a+c].anchor.offset.x=l.prototype.entities[a].anchor.offset.x,l.entities[a+c].anchor.offset.y=l.prototype.entities[a].anchor.offset.y,l.entities[a+c].anchor.x=b,l.entities[a+
c].anchor.y=d,l.entities[a+c].physics={},l.entities[a+c].physics.momentum={},l.entities[a+c].physics.momentum.x=l.prototype.entities[a].physics.momentum.x,l.entities[a+c].physics.momentum.y=l.prototype.entities[a].physics.momentum.y,l.entities[a+c].physics.momentum.total=l.prototype.entities[a].physics.momentum.total,l.prototype.entities[a].category&&(l.entities[a+c].category=l.prototype.entities[a].category),l.prototype.entities[a].sprite&&(l.entities[a+c].sprite=l.prototype.entities[a].sprite),
...
l.object.count=function(a){for(var b=Object.keys(l.entities),d=0,c=0;c<b.length;c++)l.entities[b[c]].category==a&&d++;return d};l.object["delete"]=function(a){delete l.entities[a]};
...
l.object.update=function(a){l.entities[a].anchor.x=l.entities[a].x+l.entities[a].anchor.offset.x;l.entities[a].anchor.y=l.entities[a].y+l.entities[a].anchor.offset.y;l.entities[a].bounding.x=l.entities[a].x+l.entities[a].bounding.offset.x;l.entities[a].bounding.y=l.entities[a].y+l.entities[a].bounding.offset.y};l.prototype={};l.prototype.entities={};l.prototype.count=function(a){for(var b=Object.keys(l.entities),d=0,c=0;c<b.length;c++)l.entities[b[c]].prototype==a&&d++;return d};
...
l.entities[a].animate.height,Math.round(l.entities[a].x),Math.round(l.entities[a].y),l.entities[a].animate.width/l.entities[a].animate.count,l.entities[a].animate.height):l.ctx.drawImage(l.entities[a].sprite,Math.round(l.entities[a].x),Math.round(l.entities[a].y));else for(var d=Object.keys(l.entities),c=0;c<d.length;c++)l.entities[d[c]].category==a&&l.draw.hud(d[c],b)};l.move={};l.move.snap=function(a,b,d){if(l.entities[a])l.entities[a].x=l.entities[a].anchor.offset.x?b-l.entities[a].anchor.offset.x:b,l.entities[a].y=l.entities[a].anchor.offset.y?d-l.entities[a].anchor.offset.y:d,l.object.update(a);else for(var c=Object.keys(l.entities),e=0;e<c.length;e++)l.entities[c[e]].category==a&&l.move.snap(c[e],b,d)};
...
l.move.to=function(a,b,d,c){if(l.entities[a]){var e=l.measure.x(a,b)/l.measure.total(a,b,d)*c;c*=l.measure.y(a,d)/l.measure.total(a,b,d);0<l.measure.total(a,b,d)&&(l.entities[a].anchor.x<b&&l.entities[a].anchor.y<d?(l.move.right(a,e),l.move.down(a,c)):l.entities[a].anchor.x>b&&l.entities[a].anchor.y<d?(l.move.left(a,e),l.move.down(a,c)):l.entities[a].anchor.x<b&&l.entities[a].anchor.y>d?(l.move.right(a,e),l.move.up(a,c)):l.entities[a].anchor.x>b&&l.entities[a].anchor.y>d&&(l.move.left(a,e),l.move.up(a,
c)))}else for(var e=Object.keys(l.entities),f=0;f<e.length;f++)l.entities[e[f]].category==a&&l.move.to(e[f],b,d,c)};
l.move.toward=function(a,b,d){if(l.entities[a]){var c=l.measure.x(a,b)/l.measure.total(a,b)*d;d*=l.measure.y(a,b)/l.measure.total(a,b);0<l.measure.total(a,b)&&(l.entities[a].anchor.x<l.entities[b].anchor.x&&l.entities[a].anchor.y<l.entities[b].anchor.y?(l.move.right(a,c),l.move.down(a,d)):l.entities[a].anchor.x>l.entities[b].anchor.x&&l.entities[a].anchor.y<l.entities[b].anchor.y?(l.move.left(a,c),l.move.down(a,d)):l.entities[a].anchor.x<l.entities[b].anchor.x&&l.entities[a].anchor.y>l.entities[b].anchor.y?
(l.move.right(a,c),l.move.up(a,d)):l.entities[a].anchor.x>l.entities[b].anchor.x&&l.entities[a].anchor.y>l.entities[b].anchor.y&&(l.move.left(a,c),l.move.up(a,d)))}else for(var c=Object.keys(l.entities),e=0;e<c.length;e++)l.entities[c[e]].category==a&&l.move.toward(c[e],b,d)};l.physics={};l.game.physics={};
...
l.game.physics.friction,0>l.entities[a].physics.momentum.y&&(l.entities[a].physics.momentum.y=0)));else for(var b=Object.keys(l.entities),d=0;d<b.length;d++)l.entities[b[d]].category==a&&l.physics.update(b[d])};l.physics.friction=function(a){l.game.physics.friction=a};l.physics.momentum={};l.physics.momentum.stop=function(a){l.entities[a].physics.momentum.x=0;l.entities[a].physics.momentum.y=0};
l.physics.momentum.transfer=function(a,b){l.entities[b].physics.momentum.x=l.entities[a].physics.momentum.x;l.entities[b].physics.momentum.y=l.entities[a].physics.momentum.y};l.physics.push={};l.physics.push.up=function(a,b){if(l.entities[a])l.entities[a].physics.momentum.y-=b;else for(var d=Object.keys(l.entities),c=0;c<d.length;c++)l.entities[d[c]].category==a&&l.physics.push.up(d[c],b)};
l.physics.push.down=function(a,b){if(l.entities[a])l.entities[a].physics.momentum.y+=b;else for(var d=Object.keys(l.entities),c=0;c<d.length;c++)l.entities[d[c]].category==a&&l.physics.push.down(d[c],b)};l.physics.push.left=function(a,b){if(l.entities[a])l.entities[a].physics.momentum.x-=b;else for(var d=Object.keys(l.entities),c=0;c<d.length;c++)l.entities[d[c]].category==a&&l.physics.push.left(d[c],b)};
l.physics.push.right=function(a,b){if(l.entities[a])l.entities[a].physics.momentum.x+=b;else for(var d=Object.keys(l.entities),c=0;c<d.length;c++)l.entities[d[c]].category==a&&l.physics.push.right(d[c],b)};l.physics.pull={};
l.physics.pull.to=function(a,b,d,c){if(l.entities[a]){var e=l.measure.x(a,b)/l.measure.total(a,b,d)*c;c*=l.measure.y(a,d)/l.measure.total(a,b,d);0<l.measure.total(a,b,d)&&(l.entities[a].anchor.x<b&&l.entities[a].anchor.y<d?(l.physics.push.right(a,e),l.physics.push.down(a,c)):l.entities[a].anchor.x>b&&l.entities[a].anchor.y<d?(l.physics.push.left(a,e),l.physics.push.down(a,c)):l.entities[a].anchor.x<b&&l.entities[a].anchor.y>d?(l.physics.push.right(a,e),l.physics.push.up(a,c)):l.entities[a].anchor.x>
b&&l.entities[a].anchor.y>d&&(l.physics.push.left(a,e),l.physics.push.up(a,c)))}else for(var e=Object.keys(l.entities),f=0;f<e.length;f++)l.entities[e[f]].category==a&&l.physics.pull.to(e[f],b,d,c)};
l.physics.pull.toward=function(a,b,d){if(l.entities[a]){var c=l.measure.x(a,b)/l.measure.total(a,b)*d;d*=l.measure.y(a,b)/l.measure.total(a,b);0<l.measure.total(a,b)&&(l.entities[a].anchor.x<l.entities[b].anchor.x&&l.entities[a].anchor.y<l.entities[b].anchor.y?(l.physics.push.right(a,c),l.physics.push.down(a,d)):l.entities[a].anchor.x>l.entities[b].anchor.x&&l.entities[a].anchor.y<l.entities[b].anchor.y?(l.physics.push.left(a,c),l.physics.push.down(a,d)):l.entities[a].anchor.x<l.entities[b].anchor.x&&
l.entities[a].anchor.y>l.entities[b].anchor.y?(l.physics.push.right(a,c),l.physics.push.up(a,d)):l.entities[a].anchor.x>l.entities[b].anchor.x&&l.entities[a].anchor.y>l.entities[b].anchor.y&&(l.physics.push.left(a,c),l.physics.push.up(a,d)))}else for(var c=Object.keys(l.entities),e=0;e<c.length;e++)l.entities[c[e]].category==a&&l.physics.pull.toward(c[e],b,d)};
l.physics.bounce=function(a,b,d,c,e){b||d||c||e||(b=0,d=l.canvas.width,c=0,e=l.canvas.height);if(l.entities[a]){if(l.entities[a].x<b||l.entities[a].x+l.entities[a].width>d)l.entities[a].physics.momentum.x=-l.entities[a].physics.momentum.x;if(l.entities[a].y<c||l.entities[a].y+l.entities[a].height>e)l.entities[a].physics.momentum.y=-l.entities[a].physics.momentum.y}else for(var f=Object.keys(l.entities),g=0;g<f.length;g++)l.entities[f[g]].category==a&&l.physics.bounce(f[g],b,d,c,e)};l.preloader={};l.preloader.calculate=function(){l.preloader.percent=Math.round(100*(1-l.preloader.count/l.preloader.total))};l.preloader.queue=function(){l.game.state="loading";l.preloader.count?(l.preloader.total+=1,l.preloader.count+=1):(l.preloader.total=1,l.preloader.count=1);l.preloader.calculate()};l.preloader.update=function(){l.preloader.count-=1;l.preloader.calculate();0==l.preloader.count&&(l.game.state="menu")};l.text={};l.text.write=function(a,b,d,c,e){l.ctx.fillStyle=c?c:"#000000";"hud"==e?l.ctx.fillText(a,b,d):l.ctx.fillText(a,b-l.entities.camera.x,d-l.entities.camera.y)};l.collision=function(a,b,d){if(l.entities[b])if(l.entities[a].bounding.x<l.entities[b].bounding.x+l.entities[b].bounding.width&&l.entities[a].bounding.x+l.entities[a].bounding.width>l.entities[b].bounding.x&&l.entities[a].bounding.y<l.entities[b].bounding.y+l.entities[b].bounding.height&&l.entities[a].bounding.y+l.entities[a].bounding.height>l.entities[b].bounding.y)if(d)eval(d);else return!0;else return!1;else for(var c=Object.keys(l.entities),e=0;e<c.length;e++)l.entities[c[e]].category==b&&l.collision(a,
c[e],d)};l.keyboard={};l.keyboard.enable=function(){document.body.setAttribute("onkeydown","l.keyboard.pressed(event)");document.body.setAttribute("onkeyup","l.keyboard.cancel(event)")};
...
l.keyboard.cancel=function(a){27==a.keyCode&&(l.keyboard.escape=!1);32==a.keyCode&&(l.keyboard.space=!1);13==a.keyCode&&(l.keyboard.enter=!1);16==a.keyCode&&(l.keyboard.shift=!1);65==a.keyCode&&(l.keyboard.a=!1);83==a.keyCode&&(l.keyboard.s=!1);38==a.keyCode&&(l.keyboard.up=!1);40==a.keyCode&&(l.keyboard.down=!1);37==a.keyCode&&(l.keyboard.left=!1);39==a.keyCode&&(l.keyboard.right=!1)};l.mouse={};l.mouse.clicks={};l.mouse.enable=function(){document.onmousemove=l.mouse.moved;l.dom.setAttribute("onmousedown","l.mouse.clicked(event)");l.dom.setAttribute("onmouseup","l.mouse.cancel()")};l.mouse.moved=function(a){if(a){l.mouse.x=a.clientX-l.dom.offsetLeft+l.entities.camera.x;l.mouse.y=a.clientY-l.dom.offsetTop+l.entities.camera.y;if(0>l.mouse.x||l.mouse.x>l.camera.width||0>l.mouse.y||l.mouse.y>l.camera.height)l.mouse.x=null,l.mouse.y=null;l.mouse.debug()}};
l.mouse.clicked=function(a){a&&(l.mouse.clicked.x=a.x-l.dom.offsetLeft,l.mouse.clicked.y=a.y-l.dom.offsetTop,l.mouse.debug())};l.mouse.cancel=function(a){l.mouse.clicked.x=null;l.mouse.clicked.y=null;l.mouse.debug()};l.mouse.debug=function(){if(l.debug.mouse||l.debug.all)l.mouse.x&&l.mouse.y&&console.log("Mouse at X: "+l.mouse.x+" Y: "+l.mouse.y),l.mouse.clicked.x&&l.mouse.clicked.y&&console.log("Click at X: "+l.mouse.clicked.x+" Y: "+l.mouse.clicked.y)};l.tilt={};l.tilt.x=0;l.tilt.y=0;l.tilt.z=0;l.tilt.enable=function(){document.addEventListener("deviceorientation",function(a){l.tilt.x=a.beta;l.tilt.y=a.alpha;l.tilt.z=a.gamma;l.tilt.debug()},!0)};l.tilt.debug=function(){l.debug.tilt&&console.log("x: "+l.tilt.x+" y: "+l.tilt.y+" z: "+l.tilt.z)};l.touches={};l.touches.database=[];l.touches.enable=function(){document.addEventListener("touchstart",function(a){l.touches.touches(a)});document.addEventListener("touchmove",function(a){l.touches.touches(a)});document.addEventListener("touchend",function(a){l.touches.touches(a)});document.addEventListener("touchcancel",function(a){l.touches.touches(a)})};l.touches.touches=function(a){a?(l.touches.database=a.touches,l.touches.debug()):l.touches.database.length=0};
l.touches.touched=function(a){if(0<l.touches.database.length)for(var b=0;b<l.touches.database.length;b++){if(l.touches.database[b].pageX<l.entities[a].bounding.x+l.entities[a].bounding.width&&l.touches.database[b].pageX>l.entities[a].bounding.x&&l.touches.database[b].pageY<l.entities[a].bounding.y+l.entities[a].bounding.height&&l.touches.database[b].pageY>l.entities[a].bounding.y)return(l.debug.all||l.debug.touches)&&console.log(a+" was touched"),!0;if(b==l.touches.database.length-1)return!1}};
l.touches.debug=function(){if(l.debug.all||l.debug.touches&&0<l.touches.database.length)for(var a=0;a<l.touches.database.length;a++)console.log("X"+a+": "+l.touches.database[a].pageX+" Y"+a+": "+l.touches.database[a].pageY)};